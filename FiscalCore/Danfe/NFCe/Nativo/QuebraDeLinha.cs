...
namespace FiscalCore.Danfe.NFCe.Nativo
{
    internal class QuebraDeLinha
    {
        ...
        public QuebraDeLinha(AdicionarTexto adicionarTexto, ComprimentoMaximo comprimentoMaximo, int larguraDoTexto)
        {
        ...
        public AdicionarTexto DesenharComQuebras(Graphics graphics)
        {
            ...
            {
                Medida medidaParte = MedidasLinha.ObterMedidas(parte, _adicionarTexto.Fonte);
                Medida medidaPalavra = MedidasLinha.ObterMedidas(palavra, _adicionarTexto.Fonte);
            ...
            SolidBrush br = CriarSolidBrushParaQuebrarLinhas();
