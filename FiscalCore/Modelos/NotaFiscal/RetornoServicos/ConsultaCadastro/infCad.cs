...
namespace FiscalCore.NotaFiscal.RetornoServicos.ConsultaCadastro
{
    public class infCad
    {
        ...
        /// <summary>
        ///     GR11 - O campo deve ser preenchido com a sigla da UF de localização do contribuinte. Em algumas situações, a UF de
        ///     localização pode ser diferente da UF consultada. Ex. IE de
        ...
        ///     </para>
        /// </summary>
        public eIndicadorCredenciamentoNfe indCredNFe { get; set; }
