...
namespace FiscalCore.NotaFiscal.Informacoes.Identificacao
{
    public class ide
    {
        ...
        /// </summary>
        public eTipoNF tpNF { get; set; }

        /// <summary>
        ///     B11a - Identificador de Local de destino da operação
        /// </summary>
        public eDestinoOperacao? idDest { get; set; } //Nulable por conta da v2.00
        ...
        /// </summary>
        public eTipoImpressao tpImp { get; set; }

        /// <summary>
        ///     B22 - Tipo de Emissão da NF-e
        /// </summary>
        public eTipoEmissao tpEmis { get; set; }
        ...
        /// </summary>
        public eFinalidade finNFe { get; set; }

        /// <summary>
        ///     B25a - Indica operação com consumidor final
        /// </summary>
        public eConsumidorFinal? indFinal { get; set; } //Nulable por conta da v2.00

        /// <summary>
        ///     B25b - Indicador de presença do comprador no estabelecimento comercial no momento da operação
        /// </summary>
        public ePresencaComprador? indPres { get; set; } //Nulable por conta da v2.00

        /// <summary>
        ///     B26 - Processo de emissão utilizado com a seguinte codificação:
        /// </summary>
        public eProcessoEmissao procEmi { get; set; }
