...
using FiscalCore.NotaFiscal.Informacoes.Detalhe.DeclaracaoImportacao;
using FiscalCore.NotaFiscal.Informacoes.Detalhe.Exportacao;
using FiscalCore.NotaFiscal.Informacoes.Detalhe.ProdEspecifico;
